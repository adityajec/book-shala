               ...
               <div class="cart-item">
                  <div class="row">
                     <div class="col-md-7 center-item">
                        <img src="./Engineering-books/1.jpg" alt="">
                        <h5>C Programming book</h5>
                     </div>
                     ...
                     <div class="col-md-5 center-item">
                        ...
                        <h5> ₹ <span id="phone-total">732</span> </h5>
               ...
               <div class="cart-item">
                  <div class="row">
                     <div class="col-md-7 center-item mx-auto">
                        ...
                        <h5>Learn JavaScript quickly</h5>
                     </div>
                     <div class="col-md-5 center-item">
                        <div class="input-group number-spinner">
                        ...
                        <h5> ₹ <span id="case-total">259</span> </h5>
                        <img src="images/remove.png" alt="" class="remove-item">
                     </div>
                  </div>
               </div>
